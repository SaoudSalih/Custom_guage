...
public class CustomGauge extends View {
    ...
    public CustomGauge(Context context, AttributeSet attrs) {
        ...
        setEndValue(a.getInt(R.styleable.CustomGauge_gaugeEndValue, 0));
//        setEndValue(a.getInt(R.styleable.CustomGauge_gaugeEndValue, 0));
...
//                mPaint.setShader(new LinearGradient(0, getMeasuredHeight() / 2, 0, 0, Color.YELLOW, Color.BLUE, Shader.TileMode.CLAMP));
